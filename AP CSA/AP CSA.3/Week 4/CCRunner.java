...
public class CCRunner {
    public static void main(String[] args) {
        List <Card> myCollection = new ArrayList<Card>();
        CardCollection c1 = new CardCollection("Alan",myCollection);
        CardCollection c2 = new CardCollection("Grace",myCollection);
...
//         c2.addCard(hopper);
        ...
        ArrayList<Card> dupes = (ArrayList<Card>) c1.mergeCollections(c2);
        System.out.println(c1);
        System.out.println(c2);
