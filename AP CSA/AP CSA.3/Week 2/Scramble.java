public class Scramble {
     ...
     public static String scrambler(String s) {
          /*** TODO: Write a recursively defined function that behaves as follows:
			...
			if(s.length()==0){
            	...
            	return s.charAt(1)+s.substring(0,1);
            }else{
            	return s.charAt(s.length()-1) + scrambler(s.substring(1,s.length()/2))+s.substring(s.length()/2,s.length()-1) + s.charAt(0);
            }
     ...
     public static void main(String[] args) {
          ...
          System.out.println(scrambler(scrambler("computers")));
     }
}
