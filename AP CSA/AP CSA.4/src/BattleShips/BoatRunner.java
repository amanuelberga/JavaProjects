...
//    }
    ...
    public static void main(String[] args) {
        ...
        BoatRunner a = new BoatRunner(1, new Coordinates(1,1), 5, 9, 5, 6);

        if (w.setOccupant(a, new Coordinates(0,0)))

            System.out.println("Set a boat at (0,0)");
        //Coordinates aa = new Coordinates(22,2)
        ...
        barray[0] = new BoatRunner(1, new Coordinates(0,0), 2, 9, 5, 3);

        barray[1] = new BoatRunner(1, new Coordinates(0,7), 2, 9, 5, 3);
